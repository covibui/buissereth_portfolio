      ...
      <Box sx={{ p: 4 }}>
        ...
        >
          ...
          <Typography sx={{ fontSize: `${14 / 16}rem` }}>
            ...
            involved parties. Any identifiable information has been
            intentionally removed or replaced to ensure anonymity and protect
            the clients&apos; identities. These precautions have been taken to
            uphold the utmost confidentiality and respect for all parties
