...
keyFeatures:
  ...
  - title: "Clearly see what properties fit within everyone's budgets and requirements"
...
Question 1, “Who are you?”, helps us designate where to prioritize the user’s central location, whether it is a college campus, a workplace, or something else. Question 2, “What are you looking for", helps ApartMentor prioritize the ty pes of listings most helpful for the user. Question 3, “Are you looking alone?” helps ApartMentor’s backend understand whether or not to introduce the app’s group searching function to the user. Finally, Question 4, “How can ApartMentor help you?” dictates how in-your-face ApartMentor’s app and apartment tutorials will be for the individual user. We felt these four questions would get us the critical information we need to make the application useful to the user without overbearing them with too much on startup.
