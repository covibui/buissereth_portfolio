...
hero:
  image: "/assets/images/apartmentor-thumb.png"
...
![Screenshot of Zillow's mobile app](/assets/images/apartmentor-zillow-screenshot.png){.w-full .max-w-sm .md:w-1/2}
![Screenshot of Zillow's website showcasing an apartment listing](/assets/images/apartmentor-zillow-screenshot02.png){.w-full .max-w-sm .md:w-1/2} {.flex .gap-6 .flex-col .md:flex-row}
...
![Screenshot of Apartments.com's mobile app onboarding process with a tips overlay](/assets/images/apartmentor-apartments-screenshot.png){.w-full .max-w-sm .md:w-1/2}
![Screenshot of Apartments.com's mobile app onboarding process with a tips overlay](/assets/images/apartmentor-apartments-screenshot02.png){.w-full .max-w-sm .md:w-1/2} {.flex .gap-6 .flex-col .md:flex-row}
...
![Screenshot of Apartments.com showcasing a listing's Walk and Transit Scores](/assets/images/apartmentor-apartments-screenshot03.png){.w-full .max-w-sm .md:w-1/2}
![Screenshot of Apartments.com showcasing a listing's Noise Scores](/assets/images/apartmentor-apartments-screenshot04.png){.w-full .max-w-sm .md:w-1/2} {.flex .gap-6 .flex-col .md:flex-row}
...
![Screenshot of Doulingo's mobile app showing a Spanish language lesson](/assets/images/apartmentor-doulingo-screenshot.jpeg){.w-full .max-w-sm .md:w-1/2}
...
![Screenshot of Mint's mobile app showing a budgeting chart](/assets/images/apartmentor-mint-screenshot.jpeg){.w-full .max-w-sm .md:w-1/2}
![Screenshot of Mint's mobile app showing a credit score](/assets/images/apartmentor-mint-screenshot02.jpeg){.w-full .max-w-sm .md:w-1/2} {.flex .gap-6 .flex-col .md:flex-row}

### Methodology for Design

![Apartmentor style tile](/assets/images/apartmentor-design-methodology.png)
...
![Screenshot of Question 2 from ApartMentor's onboarding process asking what type of property the user is looking for](/assets/images/apartmentor-question02.png){.w-full .max-w-sm .md:w-1/2}
...
![Screenshot of the Filters tab available in ApartMentor to narrow search results](/assets/images/apartmentor-filters.png){.w-full .max-w-sm .md:w-1/2}
...
![Screenshot of a listing page within ApartMentor](/assets/images/apartmentor-listing.png){.w-full .max-w-sm .md:w-1/2}
...
![Screenshot of the Lessons page within ApartMentor](/assets/images/apartmentor-lessons.png){.w-full .max-w-sm .md:w-1/2}
...
![Screenshot of the Budgeting page within ApartMentor](/assets/images/apartmentor-budgeting.png){.w-full .max-w-sm .md:w-1/2}
